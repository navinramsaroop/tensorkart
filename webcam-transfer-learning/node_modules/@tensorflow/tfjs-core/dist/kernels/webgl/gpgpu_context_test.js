...
test_util_1.describeWithFlags('GPGPUContext downloadMatrixFromTexture', test_util_1.WEBGL_ENVS, function () {
    var gpgpu;
    var texture;
    beforeEach(function () {
...
test_util_1.describeWithFlags('GPGPUContext color texture with float', test_util_1.WEBGL_ENVS, function () {
    var gpgpu;
    var texture;
    afterEach(function () {
        gpgpu.deleteMatrixTexture(texture);
...
test_util_1.describeWithFlags('GPGPUContext color texture with byte', { 'WEBGL_FLOAT_TEXTURE_ENABLED': false }, function () {
    var gpgpu;
    var texture;
    afterEach(function () {
        gpgpu.deleteMatrixTexture(texture);
...
test_util_1.describeWithFlags('GPGPUContext setOutputMatrixTexture', test_util_1.WEBGL_ENVS, function () {
    var gpgpu;
    var texture;
    beforeEach(function () {
        gpgpu = new gpgpu_context_1.GPGPUContext();
...
test_util_1.describeWithFlags('GPGPUContext setOutputPackedMatrixTexture', test_util_1.WEBGL_ENVS, function () {
    var gpgpu;
    var texture;
    beforeEach(function () {
        gpgpu = new gpgpu_context_1.GPGPUContext();
...
test_util_1.describeWithFlags('GPGPUContext setOutputMatrixWriteRegion', test_util_1.WEBGL_ENVS, function () {
    var gpgpu;
    var program;
    var output;
    beforeEach(function () {
...
test_util_1.describeWithFlags('GPGPUContext', test_util_1.WEBGL_ENVS, function () {
    var gpgpu;
    beforeEach(function () {
        gpgpu = new gpgpu_context_1.GPGPUContext();
        gpgpu.enableAutomaticDebugValidation(true);
