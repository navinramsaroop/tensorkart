...
test_util_1.describeWithFlags('mulmat_packed_gpu (1x1 * 1x1)', test_util_1.WEBGL_ENVS, function () {
...
test_util_1.describeWithFlags('mulmat_packed_gpu (dot product)', test_util_1.WEBGL_ENVS, function () {
    it('returns a 1x1 matrix', function () {
...
test_util_1.describeWithFlags('mulmat_packed_gpu (2x2 * 2x2)', test_util_1.WEBGL_ENVS, function () {
...
test_util_1.describeWithFlags('mulmat_packed_gpu (different shapes)', test_util_1.WEBGL_ENVS, function () {
...
test_util_1.describeWithFlags('mulmat_packed_gpu (large matrices)', test_util_1.WEBGL_ENVS, function () {
...
test_util_1.describeWithFlags('mulmat_packed_gpu (multiple matrices)', test_util_1.WEBGL_ENVS, function () {
...
test_util_1.describeWithFlags('mulmat_packed_gpu A * B^t', test_util_1.WEBGL_ENVS, function () {
    it('1x1 * 1x1', function () {
...
test_util_1.describeWithFlags('mulmat_packed_gpu (transposed versions)', test_util_1.WEBGL_ENVS, function () {
    it('A * B^t', function () {
