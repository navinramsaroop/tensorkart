...
test_util_1.describeWithFlags('loadWeights', test_util_1.CPU_ENVS, function () {
    ...
    it('throws if requested weight not found', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, tf.loadWeights(manifest, './', weightsNamesToFetch)];
                case 2:
                    _a.sent();
                    done.fail();
                    return [3, 4];
    ...
    it('should use request option', function (done) {
        ...
        var weightsNamesToFetch = ['weight0'];
        tf.loadWeights(manifest, './', weightsNamesToFetch, { credentials: 'include' })
            .then(function (weights) {
            expect(window.fetch.calls.count()).toBe(1);
